...
export type DebugBreakpointPath = {
    breakpoint_id: string;
    workspace_id: string;
};

export type DebugControlQuery = {
    principalId: string;
};
...
export type DebugLimits = {
    concurrentInspectionRequests: number;
    consoleBytes: number;
...
export type RequestedSourceBreakpoint = {
    breakpointId: string;
    column?: number | null;
    condition?: string | null;
    enabled: boolean;
...
export type RuntimeCapabilities = {
    ...
    supportsLoadedSources: boolean;
    supportsLogPoints: boolean;
    supportsPause: boolean;
    supportsStepBack: boolean;
    supportsValueFormatting: boolean;
...
export type SessionSnapshot = {
    ...
    requestedBreakpoints: Array<RequestedSourceBreakpoint>;
     ...
     */
    verifiedBreakpoints: Array<VerifiedBreakpoint>;
    workspaceId: string;
};
...
export type VerifiedBreakpoint = {
    ...
    resolvedSource?: PublicSource | null;
    sessionId: string;
    verified: boolean;
};
...
export type ListBreakpointsData = {
    body?: never;
    path: {
        /**
         * Public ID of the workspace containing the launch configuration.
...
export type CreateBreakpointData = {
    body: CreateBreakpoint;
    path: {
        /**
         * Public ID of the workspace containing the launch configuration.
         */
...
export type DeleteBreakpointData = {
...
export type UpdateBreakpointData = {
...
export type RestartSessionData = {
    ...
    url: '/api/workspaces/{workspace_id}/debug/sessions/{session_id}/restart';
};
