...
class XTerm extends React.Component<XTermProps> {
  /**
  ...
  componentDidMount() {
    ...
    if (this.props.customWheelEventHandler) {
      this.terminal.attachCustomWheelEventHandler(this.props.customWheelEventHandler);
    }
    ...
    if (this.elementRef.current === null || this.elementRef.current === undefined) {
