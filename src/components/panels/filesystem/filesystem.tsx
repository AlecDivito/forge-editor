  ...
  return (
    ...
    `}>
          <FaFile
            size={20}
            title="Create File"
            className={view === "file" ? "text-sidebar-foreground" : "text-sidebar-accent-foreground"}
          />
    ...
    `}>
          <FaSearch
            size={20}
            title="Search files"
            className={view === "search" ? "text-sidebar-foreground" : "text-sidebar-accent-foreground"}
          />
        ...
        <button
          type="button"
          onClick={() => setView("git")}
          className={`relative flex h-12.5 w-12.5 items-center justify-center transition-colors ${view === "git" ? "bg-background text-sidebar-foreground" : "bg-sidebar text-sidebar-accent-foreground"}`}
